...
@st.cache_data(ttl=120, show_spinner="در حال دریافت ۵۰۰ رمزارز برتر از CoinGecko...")
...
def main():
    st.title("سامانه هوشمند تحلیل نقدینگی و سفارش‌گذاری (Stop Hunt) — تست آپدیت ۱۴۰۴")
